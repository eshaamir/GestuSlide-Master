        ...
        <div className='container'>
            <div className='portfolio-content'>
                <div className='section-t text-center'>
                    <h3>UserGuide</h3>
                    <p className='text'>Welcome to GestuSlide Master! This visual guide will walk you through the basic steps to get started with our revolutionary presentation tool.</p>
                </div>
